...
<div class="overflow-hidden w-full my-20">
  <div class="grid grid-cols-12 2xl:px-24 gap-y-10 italic">
    <div
    ...
    >
      ...
      >
        <h2 class="text-2xl font-semibold italic uppercase sm:text-right">
          Contact Us
        </h2>
      </div>
    </div>
    {#each hqs as item, index}
      ...
      >
        <div
          class="col-span-full sm:col-span-3 sm:justify-end flex items-center gap-5"
        >
          <h3 class="col-span-full select-none text-xl sm:text-right uppercase">
            {item.location}
          </h3>
          <button
              ...
              {#each item.officers as officer}
                ...
                >
                  ...
                  {#if officer.localpost}
                    <div class="flex flx-col gap-5 col-span-full sm:col-span-6">
